...
7. Check the deployed English and Thai pages. **HTTP/content-integrity verification passed on 2026-07-15 for the earlier candidate, but that evidence was superseded by the localized accessibility-output correction. Verification of the corrected candidate is pending; rendered review remains part of step 6.**
