...
export const lessonRegistry = [
  {
    ...
    reviewRecord: "docs/lesson-reviews/what-is-electricity-v0.1.md",
  ...
  },
  {
    ...
    summaries: {
      en: "Electric-field energy, capacitance, charge-voltage and current-voltage laws, RC transients, real-component limits, and stored-energy safety.",
      th: "ความจุและพลังงานในสนามไฟฟ้า ความสัมพันธ์ของประจุ แรงดัน และกระแส ภาวะชั่วครู่ RC ข้อจำกัดของชิ้นส่วนจริง และความปลอดภัยจากพลังงานสะสม",
    },
    paths: {
    ...
    reviewRecord: "docs/lesson-reviews/capacitor-v0.1.md",
    demoComponent: "CapacitorFieldDemo",
  },
  {
    slug: "diode",
